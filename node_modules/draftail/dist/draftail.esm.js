import { DefaultDraftInlineStyle, EditorState, Modifier, AtomicBlockUtils, RichUtils, SelectionState, DefaultDraftBlockRenderMap, getDefaultKeyBinding, KeyBindingUtil } from 'draft-js';
import isSoftNewlineEvent from 'draft-js/lib/isSoftNewlineEvent';
import { filterEditorState } from 'draftjs-filters';
import { blockDepthStyleFn, ListNestingStyles, registerCopySource, handleDraftEditorPastedText, createEditorStateFromRaw, serialiseEditorStateToRaw } from 'draftjs-conductor';
...
function (_PureComponent) {
  ...
  _createClass(ToolbarButton, [{
    ...
    value: function render() {
      ...
      }, typeof icon !== "undefined" && icon !== null ? React.createElement(Icon, {
        icon: icon
...
function (_PureComponent) {
  ...
  _createClass(ToolbarDefaults, [{
    ...
    value: function render() {
      ...
      }) : null, enableLineBreak ? React.createElement(ToolbarButton, {
        name: BR_TYPE,
        onClick: addBR,
      ...
      }) : null), React.createElement(ToolbarGroup, {
        key: "entities"
      ...
      }) : null, showRedoControl ? React.createElement(ToolbarButton, {
        name: REDO_TYPE,
        onClick: onUndoRedo,
...
var Toolbar = function Toolbar(props) {
  ...
  return React.createElement("div", {
    ...
    role: "toolbar"
  }, React.createElement(ToolbarDefaults, props), React.createElement(ToolbarGroup, null, controls.map(function (Control, i) {
    return React.createElement(Control // eslint-disable-next-line @thibaudcolas/cookbook/react/no-array-index-key
    , {
      key: i,
...
function (_Component) {
  ...
  function DraftailEditor(props) {
    ...
    if (editorState !== null) {
      _this.getEditorState = _this.getEditorStateProp.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    } else {
      ...
      _this.getEditorState = _this.getEditorStateState.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    }
  ...
  _createClass(DraftailEditor, [{
    ...
    value: function renderSource() {
      ...
      if (sourceOptions && sourceOptions.entityType) {
        ...
        return React.createElement(Source // The editorState is available for arbitrary content manipulation.
        , {
    ...
    value: function render() {
      ...
      }, TopToolbar ? React.createElement(TopToolbar, toolbarProps) : null, React.createElement(Editor, {
      ...
      }), BottomToolbar ? React.createElement(BottomToolbar, toolbarProps) : null, this.renderSource(), React.createElement(ListNestingStyles, {
        max: maxListNesting
      }));
    }
  }]);
