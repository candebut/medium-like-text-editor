...
var decorateComponentWithProps = _interopDefault(require('decorate-component-with-props'));
...
function (_Component) {
  ...
  function DraftailEditor(props) {
    ...
    if (editorState !== null) {
      ...
      _this.state.editorState = draftjsConductor.createEditorStateFromRaw(rawContentState);
  ...
  _createClass(DraftailEditor, [{
    ...
    value: function componentDidMount() {
      this.copySource = draftjsConductor.registerCopySource(this.editorRef.editor);
    }
  }, {
    ...
    value: function saveState() {
      ...
      if (onSave) {
        onSave(draftjsConductor.serialiseEditorStateToRaw(editorState));
      }
    }
    ...
    value: function handleReturn(e) {
      ...
      if (e.altKey) {
        ...
        if (!newLineState && newStyle) {
          ...
          var newContent = draftJs.Modifier.splitBlock(_content2, selection);
          newState = draftJs.EditorState.push(newState, newContent, "split-block"); // Do not propagate the style from the last block.

          newState = draftJs.RichUtils.toggleInlineStyle(newState, newStyle.type);
        } else {
    ...
    value: function render() {
      ...
      }, TopToolbar ? React__default.createElement(TopToolbar, toolbarProps) : null, React__default.createElement(Editor, {
      ...
      }), BottomToolbar ? React__default.createElement(BottomToolbar, toolbarProps) : null, this.renderSource(), React__default.createElement(draftjsConductor.ListNestingStyles, {
        max: maxListNesting
      }));
    }
  }]);
...
exports.createEditorStateFromRaw = draftjsConductor.createEditorStateFromRaw;
exports.serialiseEditorStateToRaw = draftjsConductor.serialiseEditorStateToRaw;
