...
var getContentStateFragment = _interopDefault(require('draft-js/lib/getContentStateFragment'));
var getDraftEditorSelection = _interopDefault(require('draft-js/lib/getDraftEditorSelection'));
...
/*: { max: number }*/
  ...
  return max > DRAFT_DEFAULT_MAX_DEPTH ? React.createElement("style", null, generateListNestingStyles(DRAFT_DEFAULT_DEPTH_CLASS, min, max)) : null;
};
/**
...
var draftEditorCopyListener = function draftEditorCopyListener(ref
/*: ElementRef<Editor>*/
, e
/*: Event & {
...
/*: EditorStateType*/
  ...
  if (fragmentElt) {
    ...
    var fragment = draftJs.convertFromRaw(rawContent).getBlockMap();
